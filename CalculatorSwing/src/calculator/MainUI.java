...
public class MainUI extends JFrame {
    ...
    public MainUI() {
        ...
        // Xử lý sự kiện
        btnCong.addActionListener(e -> tinh("cong"));
        btnTru.addActionListener(e -> tinh("tru"));
        btnNhan.addActionListener(e -> tinh("nhan"));
        btnChia.addActionListener(e -> tinh("chia"));
    }

    private void tinh(String phep) {
        try {
            ...
            switch (phep) {
                case "cong": kq = new Cong().tinh(a, b); break;
                case "tru": kq = new Tru().tinh(a, b); break;
                case "nhan": kq = new Nhan().tinh(a, b); break;
                case "chia": kq = new Chia().tinh(a, b); break;
            }
